id_mapping_dict = {
    ...
    "n01615458": ["ern", "erne", "grey sea eagle", "gray sea eagle", "European sea eagle", "white-tailed sea eagle//"],
    ...
    "n01821869": ["budgerigar", "budgereegah", "budgerygah", "budgie", "grass parakeet", "lovebird", "shell parakeet//"],
    ...
    "n01873310": ["platypus", "duckbill", "duckbilled platypus", "duck-billed platypus", "Ornithorhynchus anatinu"],
    ...
    "n01935395": ["earthworm", "angleworm", "fishworm", "fishing worm", "wiggler", "nightwalker", "nightcrawler", "craw"],
    ...
    "n01958038": ["quahog", "quahaug", "hard-shell clam", "hard clam", "round clam", "Venus mercenaria", "Mercenaria"],
    ...
    "n02093428": ["American Staffordshire terrier", "Staffordshire terrier", "American pit bull terrier", "pit"],
    ...
    "n02132580": ["grizzly", "grizzly bear", "silvertip", "silver-tip", "Ursus horribilis", "Ursus arctos horribili"],
    ...
    "n02169974": ["Colorado potato beetle", "Colorado beetle", "potato bug", "potato beetle", "Leptinotarsa decem"],
    ...
    "n02208498": ["Africanized bee", "Africanized honey bee", "killer bee", "Apis mellifera scutellata", "Apis me"],
    ...
    "n02268148": ["odonate"],
    "n02268443": ["dragonfly", "darning needle", "devil's darning needle", "sewing needle", "snake feeder", "snake"],
    "n02268853": ["damselfly"],
    ...
    "n02310334": ["corn earworm", "cotton bollworm", "tomato fruitworm", "tobacco budworm", "vetchworm", "Heliothis"],
    ...
    "n02357401": ["American red squirrel", "spruce squirrel", "red squirrel", "Sciurus hudsonicus", "Tamiasciurus"],
    ...
    "n02381831": ["Przewalski's horse", "Przevalski's horse", "Equus caballus przewalskii", "Equus caballus prz"],
    ...
    "n02415577": ["bighorn", "bighorn sheep", "cimarron", "Rocky Mountain bighorn", "Rocky Mountain sheep", "Ovis c"],
    ...
    "n02432291": ["Virginia deer", "white tail", "whitetail", "white-tailed deer", "whitetail deer", "Odocoileus Vi"],
    ...
    "n02475078": ["Neandertal man", "Neanderthal man", "Neandertal", "Neanderthal", "Homo sapiens neanderthalensi"],
    ...
    "n02508742": ["bassarisk", "cacomistle", "cacomixle", "coon cat", "raccoon fox", "ringtail", "ring-tailed cat", "ci"],
    ...
    "n02520147": ["flathead catfish", "mudcat", "goujon", "shovelnose catfish", "spoonbill catfish", "Pylodictus ol"],
    ...
    "n02548247": ["goosefish", "angler", "anglerfish", "angler fish", "monkfish", "lotte", "allmouth", "Lophius America"],
    "n02549248": ["frogfish"],
    ...
    "n02565072": ["smallmouth", "smallmouth bass", "smallmouthed bass", "smallmouth black bass", "smallmouthed bl"],
    "n02565324": ["largemouth", "largemouth bass", "largemouthed bass", "largemouth black bass", "largemouthed bl"],
    "n02565573": ["bass"],
    ...
    "n02747177": ["ashcan", "trash can", "garbage can", "wastebin", "ash bin", "ash-bin", "ashbin", "dustbin", "trash bar"],
    "n02747672": ["ash-pan"],
    "n02747802": ["ashtray"],
    ...
    "n02766534": ["baby buggy", "baby carriage", "carriage", "perambulator", "pram", "stroller", "go-cart", "pushchair//"],
    "n02766792": ["baby grand", "baby grand piano", "parlor grand", "parlor grand piano", "parlour grand", "parlour"],
    ...
    "n02872529": ["booster", "booster amplifier", "booster station", "relay link", "relay station", "relay transmit"],
    "n02872752": ["boot"],
    "n02873520": ["boot"],
    ...
    "n02924116": ["bus", "autobus", "coach", "charabanc", "double-decker", "jitney", "motorbus", "motorcoach", "omnibus//"],
    ...
    "n02977058": ["cash machine", "cash dispenser", "automated teller machine", "automatic teller machine", "auto"],
    "n02977330": ["cashmere"],
    ...
    "n02981792": ["catamaran"],
    "n02981911": ["catapult", "arbalest", "arbalist", "ballista", "bricole", "mangonel", "onager", "trebuchet", "trebucke"],
    ...
    "n03071160": ["colonnade"],
    "n03072201": ["color television", "colour television", "color television system", "colour television system"],
    "n03072440": ["color tube", "colour tube", "color television tube", "colour television tube", "color TV tube//"],
    "n03073296": ["Colt"],
    ...
    "n03082979": ["computer", "computing machine", "computing device", "data processor", "electronic computer", "in"],
    ...
    "n03402941": ["funeral home", "funeral parlor", "funeral parlour", "funeral chapel", "funeral church", "funeral"],
    "n03403643": ["funnel"],
    "n03404149": ["fur"],
    "n03404251": ["fur coat"],
    "n03404360": ["fur hat"],
    ...
    "n03532672": ["hook", "claw"],
    "n03532919": ["hook"],
    "n03533014": ["hookah", "narghile", "nargileh", "sheesha", "shisha", "chicha", "calean", "kalian", "water pipe", "hubbl"],
    ...
    "n03543945": ["houndstooth check", "hound's-tooth check", "dogstooth check", "dogs-tooth check", "dog's-tooth"],
    "n03544143": ["hourglass"],
    ...
    "n03918737": ["personal digital assistant", "PDA", "personal organizer", "personal organiser", "organizer", "or"],
    ...
    "n04018667": ["public toilet", "comfort station", "public convenience", "convenience", "public lavatory", "rest"],
    ...
    "n04124488": ["saddlery"],
    "n04125021": ["safe"],
    "n04125257": ["safe-deposit", "safe-deposit box", "safety-deposit", "safety deposit box", "deposit box", "lockb"],
    ...
    "n04363777": ["surcoat"],
    "n04363991": ["surgery"],
    "n04364160": ["surge suppressor", "surge protector", "spike suppressor", "spike arrester", "lightning arreste"],
    ...
    "n04400289": ["telecommunication system", "telecom system", "telecommunication equipment", "telecom equipme"],
    ...
    "n04405907": ["television receiver", "television", "television set", "tv", "tv set", "idiot box", "boob tube", "tel"],
    ...
    "n04493381": ["tub", "vat"],
    "n04494204": ["tube", "vacuum tube", "thermionic vacuum tube", "thermionic tube", "electron tube", "thermionic"],
    "n04495698": ["tudung"],
    ...
    "n07697825": ["bomber", "grinder", "hero", "hero sandwich", "hoagie", "hoagy", "Cuban sandwich", "Italian sandwich//"],
    "n07698250": ["gyro"],
    ...
    "n07907548": ["Scotch", "Scotch whiskey", "Scotch whisky", "malt whiskey", "malt whisky", "Scotch malt whiskey//"],
    ...
    "n08521623": ["cemetery", "graveyard", "burial site", "burial ground", "burying ground", "memorial park", "necrop"],
    ...
    "n08573842": ["garbage heap", "junk heap", "rubbish heap", "scrapheap", "trash heap", "junk pile", "trash pile", "r"],
    ...
    "n09376198": ["ocean"],
    "n09376526": ["ocean floor", "sea floor", "ocean bottom", "seabed", "sea bottom", "Davy Jones's locker", "Davy Jo"],
    ...
    "n09839702": ["barmaid"],
    "n09840217": ["baron", "big businessman", "business leader", "king", "magnate", "mogul", "power", "top executive", "t"],
    "n09840520": ["baron"],
    ...
    "n09917593": ["child", "kid", "youngster", "minor", "shaver", "nipper", "small fry", "tiddler", "tike", "tyke", "fry", "nes"],
    "n09918248": ["child", "kid"],
    ...
    "n10117851": ["gal"],
    "n10120330": ["garbage man", "garbageman", "garbage collector", "garbage carter", "garbage hauler", "refuse col"],
    "n10120671": ["gardener"],
    "n10123122": ["gendarme"],
    ...
    "n10613996": ["smasher", "stunner", "knockout", "beauty", "ravisher", "sweetheart", "peach", "lulu", "looker", "mantrap"],
    ...
    "n11612349": ["Swiss mountain pine", "mountain pine", "dwarf mountain pine", "mugho pine", "mugo pine", "Pinus"],
    ...
    "n11621281": ["amabilis fir", "white fir", "Pacific silver fir", "red silver fir", "Christmas tree", "Abies ama"],
    ...
    "n11628793": ["green douglas fir", "douglas spruce", "douglas pine", "douglas hemlock", "Oregon fir", "Oregon p"],
    ...
    "n11635152": ["southern white cedar", "coast white cedar", "Atlantic white cedar", "white cypress", "white ce"],
    "n11635433": ["Oregon cedar", "Port Orford cedar", "Lawson's cypress", "Lawson's cedar", "Chamaecyparis lawso"],
    ...
    "n11653904": ["kahikatea", "New Zealand Dacryberry", "New Zealand white pine", "Dacrycarpus dacrydioides", "P"],
    ...
    "n11699442": ["Oregon grape", "Oregon holly grape", "hollygrape", "mountain grape", "holly-leaves barberry", "M"],
    "n11700058": ["mayapple", "May apple", "wild mandrake", "Podophyllum peltatum"],
    "n11701066": ["Carolina allspice", "strawberry shrub", "strawberry bush", "sweet shrub", "Calycanthus floridu"],
    "n11703669": ["laurel"],
    ...
    "n11709674": ["magnolia"],
    "n11710136": ["southern magnolia", "evergreen magnolia", "large-flowering magnolia", "bull bay", "Magnolia gr"],
    ...
    "n11720643": ["meadow buttercup", "tall buttercup", "tall crowfoot", "tall field buttercup", "Ranunculus acri"],
    ...
    "n11728099": ["marsh marigold", "kingcup", "meadow bright", "May blob", "cowslip", "water dragon", "Caltha palust"],
    ...
    "n11757851": ["huisache", "cassie", "mimosa bush", "sweet wattle", "sweet acacia", "scented wattle", "flame tree//"],
    "n11758122": ["lightwood", "Acacia melanoxylon"],
    "n11758276": ["golden wattle", "Acacia pycnantha"],
    "n11758483": ["fever tree", "Acacia xanthophloea"],
    "n11758799": ["coralwood", "coral-wood", "red sandalwood", "Barbados pride", "peacock flower fence", "Adenanthe"],
    ...
    "n11772408": ["periwinkle", "rose periwinkle", "Madagascar periwinkle", "old maid", "Cape periwinkle", "red per"],
    ...
    "n11784497": ["jack-in-the-pulpit", "Indian turnip", "wake-robin", "Arisaema triphyllum", "Arisaema atroruben"],
    "n11785668": ["caladium"],
    ...
    "n11797321": ["aralia"],
    "n11800236": ["ginseng"],
    "n11801891": ["Virginia snakeroot", "Virginia serpentaria", "Virginia serpentary", "Aristolochia serpentari"],
    ...
    "n11816336": ["white campion", "evening lychnis", "white cockle", "bladder campion", "Silene latifolia", "Lychn"],
    ...
    "n11882426": ["crinkleroot", "crinkle-root", "crinkle root", "pepper root", "toothwort", "Cardamine diphylla", "D"],
    ...
    "n11898775": ["field pennycress", "French weed", "fanweed", "penny grass", "stinkweed", "mithridate mustard", "Th"],
    "n11900569": ["poppy"],
    ...
    "n11925898": ["marguerite", "marguerite daisy", "Paris daisy", "Chrysanthemum frutescens", "Argyranthemum fru"],
    ...
    "n11961100": ["florist's chrysanthemum", "florists' chrysanthemum", "mum", "Dendranthema grandifloruom", "Chr"],
    ...
    "n11989869": ["oxeye daisy", "ox-eyed daisy", "marguerite", "moon daisy", "white daisy", "Leucanthemum vulgare//"],
    ...
    "n11995092": ["sweet false chamomile", "wild chamomile", "German chamomile", "Matricaria recutita", "Matricar"],
    "n11998888": ["cotton thistle", "woolly thistle", "Scotch thistle", "Onopordum acanthium", "Onopordon acanthi"],
    ...
    "n12015525": ["milk thistle", "lady's thistle", "Our Lady's mild thistle", "holy thistle", "blessed thistle//"],
    "n12015959": ["goldenrod"],
    ...
    "n12023407": ["dusty miller", "silver-lace", "silver lace", "Tanacetum ptarmiciflorum", "Chrysanthemum ptarmi"],
    ...
    "n12030908": ["wingstem", "golden ironweed", "yellow ironweed", "golden honey plant", "Verbesina alternifolia"],
    "n12031139": ["cowpen daisy", "golden crownbeard", "golden crown beard", "butter daisy", "Verbesina encelioid"],
    ...
    "n12056758": ["common lady's-slipper", "showy lady's-slipper", "showy lady slipper", "Cypripedium reginae//"],
    "n12057211": ["yellow lady's slipper", "yellow lady-slipper", "Cypripedium calceolus", "Cypripedium parvifl"],
    ...
    "n12067193": ["ragged orchid", "ragged orchis", "ragged-fringed orchid", "green fringed orchis", "Habenaria l"],
    ...
    "n12108871": ["tall oat grass", "tall meadow grass", "evergreen grass", "false oat", "French rye", "Arrhenather"],
    ...
    "n12133462": ["broom beard grass", "prairie grass", "wire grass", "Andropogon scoparius", "Schizachyrium scop"],
    "n12133682": ["bluestem", "blue stem", "Andropogon furcatus", "Andropogon gerardii"],
    "n12134025": ["rye", "Secale cereale"],
    "n12135049": ["green bristlegrass", "green foxtail", "rough bristlegrass", "bottle-grass", "bottle grass", "Set"],
    ...
    "n12162425": ["prairie gourd", "prairie gourd vine", "Missouri gourd", "wild pumpkin", "buffalo gourd", "calaba"],
    ...
    "n12173069": ["velvetleaf", "velvet-leaf", "velvetweed", "Indian mallow", "butter-print", "China jute", "Abutilon"],
    "n12173664": ["hollyhock"],
    ...
    "n12190410": ["kapok", "ceiba tree", "silk-cotton tree", "white silk-cotton tree", "Bombay ceiba", "God tree", "C"],
    ...
    "n12198286": ["Chinese parasol tree", "Chinese parasol", "Japanese varnish tree", "phoenix tree", "Firmiana s"],
    "n12199790": ["red beech", "brown oak", "booyong", "crow's foot", "stave wood", "silky elm", "Heritiera trifoliol"],
    ...
    "n12249542": ["cowberry", "mountain cranberry", "lingonberry", "lingenberry", "lingberry", "foxberry", "Vaccinium"],
    "n12252168": ["shortia"],
    "n12257570": ["pipsissewa", "prince's pine"],
    "n12258885": ["Indian pipe", "waxflower", "Monotropa uniflora"],
    "n12260799": ["beech", "beech tree"],
    "n12261571": ["copper beech", "purple beech", "Fagus sylvatica atropunicea", "Fagus purpurea", "Fagus sylvati"],
    ...
    "n12281974": ["American white birch", "paper birch", "paperbark birch", "canoe birch", "Betula cordifolia", "Be"],
    ...
    "n12283542": ["swamp birch", "water birch", "mountain birch", "Western paper birch", "Western birch", "Betula f"],
    ...
    "n12295796": ["agueweed", "ague weed", "five-flowered gentian", "stiff gentian", "Gentianella quinquefolia", "G"],
    ...
    "n12312728": ["kangaroo paw", "kangaroo's paw", "kangaroo's-foot", "kangaroo-foot plant", "Australian sword l"],
    "n12315598": ["winter hazel", "flowering hazel"],
    "n12315999": ["fothergilla", "witch alder"],
    "n12316444": ["liquidambar"],
    "n12316572": ["sweet gum", "sweet gum tree", "bilsted", "red gum", "American sweet gum", "Liquidambar styracifl"],
    ...
    "n12320806": ["bitternut", "bitternut hickory", "bitter hickory", "bitter pignut", "swamp hickory", "Carya cord"],
    "n12322099": ["mockernut", "mockernut hickory", "black hickory", "white-heart hickory", "big-bud hickory", "Car"],
    ...
    "n12342852": ["California fuchsia", "humming bird's trumpet", "Epilobium canum canum", "Zauschneria califor"],
    "n12343480": ["fuchsia"],
    ...
    "n12357485": ["shellflower", "shall-flower", "shell ginger", "Alpinia Zerumbet", "Alpinia speciosa", "Languas s"],
    "n12360108": ["begonia"],
    ...
    "n12402348": ["banyan", "banyan tree", "banian", "banian tree", "Indian banyan", "East Indian fig tree", "Ficus b"],
    "n12402596": ["pipal", "pipal tree", "pipul", "peepul", "sacred fig", "bo tree", "Ficus religiosa"],
    "n12402840": ["India-rubber tree", "India-rubber plant", "India-rubber fig", "rubber plant", "Assam rubber", "F"],
    ...
    "n12453186": ["snake's head fritillary", "guinea-hen flower", "checkered daffodil", "leper lily", "Fritillari"],
    "n12454159": ["tulip"],
    ...
    "n12483427": ["Adam's needle", "Adam's needle-and-thread", "spoonleaf yucca", "needle palm", "Yucca filamento"],
    ...
    "n12485981": ["yellow jasmine", "yellow jessamine", "Carolina jasmine", "evening trumpet flower", "Gelsemium"],
    "n12486574": ["flax"],
    ...
    "n12491826": ["cassia"],
    "n12492106": ["golden shower tree", "drumstick tree", "purging cassia", "pudding pipe tree", "canafistola", "ca"],
    "n12493208": ["carob", "carob tree", "carob bean tree", "algarroba", "Ceratonia siliqua"],
    "n12494794": ["royal poinciana", "flamboyant", "flame tree", "peacock flower", "Delonix regia", "Poinciana regi"],
    ...
    "n12530818": ["woodwaxen", "dyer's greenweed", "dyer's-broom", "dyeweed", "greenweed", "whin", "woadwaxen", "Genist"],
    "n12532564": ["soy", "soybean", "soya bean"],
    "n12539306": ["wild pea"],
    "n12540250": ["beach pea", "sea pea", "Lathyrus maritimus", "Lathyrus japonicus"],
    "n12544539": ["lentil"],
    "n12545635": ["bird's foot trefoil", "bird's foot clover", "babies' slippers", "bacon and eggs", "Lotus corni"],
    ...
    "n12552309": ["sainfoin", "sanfoin", "holy clover", "esparcet", "Onobrychis viciifolia", "Onobrychis viciaefoli"],
    "n12554911": ["tumbleweed"],
    "n12556656": ["pole bean"],
    "n12557438": ["haricot"],
    "n12557556": ["wax bean"],
    "n12557681": ["scarlet runner", "scarlet runner bean", "Dutch case-knife bean", "runner bean", "Phaseolus coc"],
    ...
    "n12564083": ["winged bean", "winged pea", "goa bean", "goa bean vine", "Manila bean", "Psophocarpus tetragonol"],
    "n12566954": ["kudzu", "kudzu vine", "Pueraria lobata"],
    "n12568186": ["black locust", "yellow locust", "Robinia pseudoacacia"],
    "n12570394": ["Japanese pagoda tree", "Chinese scholartree", "Chinese scholar tree", "Sophora japonica", "Sop"],
    ...
    "n12577895": ["snailflower", "snail-flower", "snail flower", "snail bean", "corkscrew flower", "Vigna caracalla"],
    ...
    "n12585629": ["palmyra", "palmyra palm", "toddy palm", "wine palm", "lontar", "longar palm", "Borassus flabellife"],
    ...
    "n12598027": ["key palm", "silvertop palmetto", "silver thatch", "Thrinax microcarpa", "Thrinax morrisii", "Thr"],
    "n12599435": ["broad-leaved plantain", "common plantain", "white-man's foot", "whiteman's foot", "cart-track"],
    "n12602262": ["eriogonum"],
    ...
    "n12659539": ["bridal wreath", "bridal-wreath", "Saint Peter's wreath", "St. Peter's wreath", "Spiraea prunif"],
    "n12662772": ["coffee", "coffee tree"],
    "n12663023": ["Arabian coffee", "Coffea arabica"],
    "n12665048": ["bedstraw"],
    "n12665271": ["sweet woodruff", "waldmeister", "woodruff", "fragrant bedstraw", "Galium odoratum", "Asperula od"],
    ...
    "n12676703": ["trumpet honeysuckle", "coral honeysuckle", "trumpet flower", "trumpet vine", "Lonicera semperv"],
    "n12680402": ["cranberry bush", "cranberry tree", "American cranberry bush", "highbush cranberry", "Viburnum"],
    "n12680864": ["guelder rose", "European cranberrybush", "European cranberry bush", "crampbark", "cranberry tr"],
    ...
    "n12695975": ["chinaberry", "chinaberry tree", "China tree", "Persian lilac", "pride-of-India", "azederach", "aze"],
    ...
    "n12708654": ["sour orange", "Seville orange", "bitter orange", "bitter orange tree", "bigarade", "marmalade or"],
    ...
    "n12753762": ["moosewood", "moose-wood", "striped maple", "striped dogwood", "goosefoot maple", "Acer pennsylva"],
    ...
    "n12766869": ["poison ivy", "markweed", "poison mercury", "poison oak", "Toxicodendron radicans", "Rhus radican"],
    ...
    "n12778398": ["silver-bell tree", "silverbell tree", "snowdrop tree", "opossum wood", "Halesia carolina", "Hale"],
    ...
    "n12845413": ["painted nettle", "Joseph's coat", "Coleus blumei", "Solenostemon blumei", "Solenostemon scutel"],
    "n12847008": ["hemp nettle", "dead nettle", "Galeopsis tetrahit"],
    "n12847374": ["ground ivy", "alehoof", "field balm", "gill-over-the-ground", "runaway robin", "Glechoma hederac"],
    ...
    "n12882945": ["common foxglove", "fairy bell", "fingerflower", "finger-flower", "fingerroot", "finger-root", "Dig"],
    ...
    "n12889713": ["common mullein", "great mullein", "Aaron's rod", "flannel mullein", "woolly mullein", "torch", "Ve"],
    ...
    "n12920204": ["poinsettia", "Christmas star", "Christmas flower", "lobster plant", "Mexican flameleaf", "painte"],
    ...
    "n12925179": ["spurge nettle", "tread-softly", "devil nettle", "pica-pica", "Cnidoscolus urens", "Jatropha uren"],
    "n12926480": ["cassava", "casava"],
    "n12926689": ["bitter cassava", "manioc", "mandioc", "mandioca", "tapioca plant", "gari", "Manihot esculenta", "Man"],
    ...
    "n12935609": ["hemlock", "poison hemlock", "poison parsley", "California fern", "Nebraska fern", "winter fern//"],
    ...
    "n12947544": ["red osier", "red osier dogwood", "red dogwood", "American dogwood", "redbrush", "Cornus stolonif"],
    ...
    "n13001930": ["shiitake", "shiitake mushroom", "Chinese black mushroom", "golden oak mushroom", "Oriental bla"],
    ...
    "n13172923": ["polypody"],
    "n13173882": ["common polypody", "adder's fern", "wall fern", "golden maidenhair", "golden polypody", "sweet fe"],
    "n13177048": ["golden polypody", "serpent fern", "rabbit's-foot fern", "Phlebodium aureum", "Polypodium aureu"],
    ...
    "n13199717": ["Christmas fern", "canker brake", "dagger fern", "evergreen wood fern", "Polystichum acrosticho"],
    ...
    "n13207094": ["common maidenhair", "Venushair", "Venus'-hair fern", "southern maidenhair", "Venus maidenhair//"],
    ...
    "n13220122": ["scouring rush", "rough horsetail", "Equisetum hyemale", "Equisetum hyemale robustum", "Equiset"],
    ...
    "n13231078": ["long beech fern", "narrow beech fern", "northern beech fern", "Phegopteris connectilis", "Dryo"],
    ...
    "n13235503": ["butterfly weed", "orange milkweed", "chigger flower", "chiggerflower", "pleurisy root", "tuber r"],
    ...
    "n15091846": ["vitamin Bc", "vitamin M", "folate", "folic acid", "folacin", "pteroylglutamic acid", "pteroylmonog"],
